	  ...
	  _createClass(DateInput, [{
	    ...
	    value: function () {
	      function render() {
	        ...
	        if (arrDate.length > 1) {
	          value = _react2['default'].createElement('span', { className: 'DateInput__display-date' }, _react2['default'].createElement('span', { className: 'DateInput__display-date--day' }, arrDate[0]), _react2['default'].createElement('span', { className: 'DateInput__display-date--month' }, arrDate[1]), _react2['default'].createElement('span', { className: 'DateInput__display-date--year' }, arrDate[2]));
	        }
